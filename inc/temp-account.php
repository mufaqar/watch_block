...
<div class="flex flex-col sm:flex-row gap-3 items-center mt-5 md:mt-1">
    ...
    <div class="md:w-1/2 w-full sm:align-right flex items-center sm:justify-end gap-5">
        <a href="<?php echo home_url('/my-account/add-my-watch'); ?>"
            class="text-xl bg-[#B6E22E] w-fit p-2 hover:bg-black hover:text-[#B6E22E] rounded-lg">Sell Watch</a>
    </div>
</div>
    ...
    <div class="w-[840px]">
        ...
        <div class="watch-list p-5">
            ...
            <div class="grid grid-cols-6 gap-3 text-start py-2 items-center">
                ...
                <div><span
                        class="bg-[#f2f2f2] rounded-full font-medium py-[2px] px-5"><?php echo esc_html($size); ?></span>
                </div>
        ...
        <div class="w-[790px]">
            ...
            <div class="grid grid-cols-6 text-sm gap-3 text-start border-b py-3">
                <div>#<?php echo esc_html($ID); ?></div>
                    ...
                    <div> <a class="py-2 px-7 bg-[#B6E22E] rounded-lg font-semibold" href="<?php the_permalink()?>">View</a>
                </div>
            </div>
            <?php endwhile; ?>
        </div>
...
<div class="box-content p-[25px] pt-3 md:pt-0">
    ...
    <form class="mt-5 flex flex-col gap-5" id="stolen_watch">
        <div class="relative">
            <input type="text" name="brand" id="brand" placeholder="Rolex"
        ...
        <div class="grid grid-cols-2 gap-5">
            <input type="text" name="model_no" id="model_no" placeholder="Model"
        ...
        <textarea name="details" id="details"
            className="border-[#C0C0C0] _textarea border flex items-center !p-3 text-[#70776F] outline-black rounded-[5px] w-full"
