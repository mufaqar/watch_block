<section class="bg-[#1C1C1C] py-12">
    <div class="max-w-[1280px] flex flex-col lg:flex-row gap-10 px-3 mx-auto">
        <div class="lg:w-[40%]">
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/public/svg/five-star.svg" alt=""
                class="w-[106px] mb-8" />
            ...
            <p class="text-lg font-light text-white/70">During the 1970s and 80s, Swiss watchmakers faced the fierce
                ...
                revolutionary Beta 21 movement, a collaborative breakthrough in Swiss watchmaking.</p>
            <p class="text-lg font-light text-white/70">Crafted to perfection, this timepiece symbolizes resilience,
                precision, and timeless elegance. </p>
        ...
        <div class="lg:w-[60%]">
            <img src="<?php echo get_template_directory_uri(); ?>/public/images/timepiece.png" alt=""
