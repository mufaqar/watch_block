...
<div class="!bg-white shadow-lg z-[50] mb-10 -mt-10 relative rounded-[12px] max-w-[709px] w-full mx-auto px-[25px]">
    <div class="py-[22px] flex gap-5">
        <img src="<?php echo get_template_directory_uri(); ?>/public/svg/search.svg" alt="" class=" w-[36px]"/>
            ...
            while ($query->have_posts()) {  
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                    <figure class="h-full">
                        ...
                        <?php else: ?>
                            <img src="<?php echo get_template_directory_uri(); ?>/public/images/noaimage.png" alt="Default Image" class="w-full h-full xl:max-h-[560px] object-cover object-center"/>
                        <?php endif; ?>
                    </figure>
                    <div>
            ...
            while ($queryBlogs->have_posts()) {  
                ...
                <div class="grid grid-cols-1 gap-5 items-center">
                    <figure class="max-h-[280px]">
                        ...
                        <?php else: ?>
                            <img src="<?php echo get_template_directory_uri(); ?>/public/images/noaimage.png" alt="Default Image" class="w-full max-h-[280px] object-cover object-center"/>
                        <?php endif; ?>
                    </figure>
                    <div>
                        <div class="flex items-center gap-2 mb-6">
