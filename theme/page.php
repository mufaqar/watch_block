...
<?php if (is_shop()): ?>
    <main class="h-[700px] w-full bg-no-repeat bg-cover !bg-center px-3 sm:px-4 lg:px-8 2xl:px-[64px] flex flex-col justify-center text-white py-20 mt-[-140px]" style="background-image: url('<?php echo get_template_directory_uri(); ?>/public/images/main.jpg')">
