...
?>
	...
	<section class="bg-[#1C1C1C] max-w-[1280px] mx-auto px-5 border-b border-gray-700  md:mb-20 p-[33px] grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 sm:gap-14">
		<div>
			<h3 class="text-lg md:text-[23px] font-bold text-white uppercase text-center">Free Shipping</h3>
		...
		<div>
			<h3 class="text-lg md:text-[23px] font-bold text-white uppercase text-center">PATH TO SUSTAINABILITY</h3>
		...
		<div>
			<h3 class="text-lg md:text-[23px] font-bold text-white uppercase text-center">30-DAY TRIAL</h3>
