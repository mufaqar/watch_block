    ...
    <div class="lg:w-[65%]">
            ...
            <div class="flex items-center gap-4">
                ...
                <button class="border-l-[2px] px-4 border-r-[2px] border-gray-300">
                    <span class="bg-white w-[48px] h-[48px] rounded-full flex flex-col justify-center items-center shadow">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/svg/heart2.svg" alt="" class="w-[26px] h-[16px]">
                    </span>
                </button>
                <a href="#">                
        ...
        <div class="mt-[14px] flex gap-6 md:gap-3 flex-wrap items-center">
            <div class="bg-[#F0F0F0] inline-flex p-[14px] items-center rounded-full justify-between gap-9">
                <button>
                    <img src="<?php echo get_template_directory_uri(); ?>/images/svg/menus.svg" alt=""/>
                </button>
                1
                <button>
                    <img src="<?php echo get_template_directory_uri(); ?>/images/svg/plus.svg" alt=""/>
                </button>
            </div>
            <a href="#">                
